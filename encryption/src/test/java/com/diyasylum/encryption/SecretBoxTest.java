...
class secretBoxTest {
	...
	void decryptionFailsOnWrongSalt() {
    	...
    	EncryptedMessage modifiedSecret = new EncryptedMessage(trueSecret.getEncryptedMessage(), 
    		newSalt, trueSecret.getNonce());
	...
	void decryptionFailsOnModifiedInput() {
    	...
    	EncryptedMessage modifiedSecret = new EncryptedMessage(newMessage, 
    		trueSecret.getSalt(), trueSecret.getNonce());
    	Optional<String> decryptedMessage = box.decrypt(modifiedSecret);
