...
public class ApplicantInfoBuilder {
    ...
    public ApplicantInfoBuilder setAlsoApplyingConventionAgainstTorture(boolean alsoApplyingConventionAgainstTorture) {
    ...
    public ApplicantInfoBuilder setImmigrationCourtHistory(ImmigrationCourtHistory immigrationCourtHistory) {
    ...
    public ApplicantInfo createApplicantInfo() {
        return new ApplicantInfo(alsoApplyingConventionAgainstTorture, alienRegistrationNumber, socialSecurityNumber, usisAccountNumber, lastName, firstName, middleName, aliases, usResidence, usMailingAddress, gender, maritalStatus, dateOfBirth, cityOfBirth, countryOfBirth, presentNationality, nationalityAtBirth, raceEthnicOrTribalGroup, religion, immigrationCourtHistory, countryWhoLastIssuedPassport, passportNumber, travelDocumentNumber, travelDocumentExpirationDate, nativeLanguage, fluentInEnglish, otherLanguages);
    }
}